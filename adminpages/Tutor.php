...
<head>
	...
	<link href="admincss/Tutor.css" rel="stylesheet"> 
			...
			<div  class='sidebar col-lg-2 col-md-2 col-sm-3 col-xs-12  ' id='side-bar' >
				...
				<div class='row' id='menu'>
					<ul>
						...
						<li class='active'><a href='Tutor.php'><img src='images/tutor_sm_icon.jpg' class='img pull-left tutor1-img img-responsive'> Tutor</a></li>
