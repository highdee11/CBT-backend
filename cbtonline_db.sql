...
--
-- Host: localhost
-- Generation Time: Jan 10, 2017 at 01:56 AM
...
(1, ';giug', 'igkg', 'gjkhgjkhg', 'gjhg', 'jhgjgkj', '', 'physics', 'NECO', 4, 'none', 'Y'),
(2, 'klghhlkjhi', 'h kjhjh', 'gjhgjg', 'hgjkhgkjhg', 'jkhgjhgh', '', 'physics', 'Jamb', 3, 'none', 'Y'),
